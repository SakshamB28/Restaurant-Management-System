...
if(count($_POST)>0) {
	$conn = mysqli_connect("localhost","root","","restaurant_system");
        ...
        {        
            ...
            $rndm = rand(1,10000);
            $result = mysqli_query($conn," insert into user values ('" . $_POST["userName"] . "','" . $_POST["password"] . "','" . $_POST["privilage"] . "','0')");
            $result1 = mysqli_query($conn," insert into details values ('" . $rndm . "','" . $_POST["userName"] . "','" . $_POST["city"] . "','" . $_POST["phn"] . "')");
            $message = "Username added successfully!!  User ID for '" . $_POST["userName"] . "'  is $rndm";
        }
    }
?>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="integer" name="phn" required>
                                </div>
                            </div>
                        </div>
						 <div class="row row-space">
